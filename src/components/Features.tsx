      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Leverage advanced analytics and machine learning to turn raw data into actionable business intelligence."
            index={0}
          />
          <FeatureCard
            ...
            description="Seamlessly interact with customers through natural language processing and real-time chatbot solutions."
            index={1}
          />
          <FeatureCard
            ...
            description="Enable image and video analysis across industries—object detection, OCR, and surveillance automation."
            index={2}
          />
          <FeatureCard
            ...
            description="Our solutions integrate smoothly with existing platforms, from web to mobile to IoT."
            index={3}
          />
          <FeatureCard
            ...
            description="We embed AI ethics and encryption into our systems to ensure data integrity and user trust."
            index={4}
          />
          <FeatureCard
            ...
            title="Scalable APIs & Tools"
            description="Modular and developer-friendly APIs for easy implementation into business workflows."
            index={5}
          />
        </div>
      </div>
