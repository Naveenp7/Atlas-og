...
const StepCard = ({ number, title, description, isActive, onClick, link }: StepCardProps) => {
  const handleClick = () => {
    if (link) {
  ...
  const stepsData = [
    {
      number: "01",
      title: "Connect",
      description: "Get in touch with our team to explore how Allied can align with your business or personal tech needs. We’ll schedule a discovery session to understand your goals and challenges.",
      image: "/vis.png",
      link: "#details"
    },
    {
      number: "02",
      title: "Customize",
      description: "Our AI engineers tailor solutions specifically for your environment  whether it’s data workflows, intelligent assistants, or predictive systems. Custom-built to solve your real-world problems.",
      image: "/vis.png"
    },
    {
      number: "03",
      title: "Deploy",
      description: "We seamlessly integrate Allied’s systems into your digital infrastructure. From API integration to real-time machine learning pipelines, we make deployment effortless.",
      image: "/vis.png"
    },
    {
      number: "04",
      title: "Optimize",
      description: "Allied adapts and evolves over time, continuously improving performance using live feedback and intelligent analytics. You grow — so does Allied.",
      image: "/vis.png"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4"> How Allied Transforms Your Ecosystem</h2>
          <p className="section-subtitle mx-auto">
            A seamless four-step journey from connection to transformation.
          </p>
        </div>
